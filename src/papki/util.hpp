 ...
 * @param pathname - path string to omit directories from.
 * @return filename.
 */
std::string not_dir(const std::string& pathname);

/**
 * @brief Get directory part of the path.
 * Example: if path is '/home/user/some.file.txt' then the return value
 * will be '/home/user/'.
 * @param pathname - path string to get directory part from.
 * @return String representation of directory part of the path.
 */
std::string dir(const std::string& pathname);
 ...
 * @param pathname - path string to get the suffix from.
 * @return String representing file suffix.
 */
std::string suffix(const std::string& pathname);
